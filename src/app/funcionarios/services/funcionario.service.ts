...
import { Requisicao } from 'src/app/requisicoes/models/requisicao.model';
...
export class FuncionarioService {
  ...
  constructor(private firestore: AngularFirestore) {
    this.registros = this.firestore.collection<Funcionario>("funcionario");
   }
  ...
  selecionarFuncionarioLogado(email: string): Observable<Funcionario>{
    return this.firestore
      .collection<Funcionario>('funcionario', ref => {
